...
// this method will assert expected and actual text
    ...
    public  static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/com/orange/hrm/screenshots/";
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "s/rc/main/java/com/orange/hrm/screenshots/" + screenshotName + dateName + ".png";
